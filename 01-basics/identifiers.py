...
x = 0
# global = 1 identifikátor nesmí mít název jako klíčové slovo
y = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' identifkátor nesmí obsahovat speciální symboly
hilda_sspu_opava_cz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
# 007agent = 'James Bond' název identifikátoru nesmí začínat číslem
agent007 = 'James Bond'
